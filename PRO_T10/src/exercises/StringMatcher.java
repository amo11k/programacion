...
public class StringMatcher {
	...
	// 3.- A method that returns true if the string contains just 3 letters (no
	// digits).
	public static boolean method3(String s) {
		return s.matches("[a-zA-Z]{3}");
	}

	// A method that returns true if the string does not have a number at the
	// beginning.
	public static boolean method4(String s) {
		return s.matches("[^0-9]*");
	}

	// A method that returns true if the string contains an arbitrary numbers of
	// characters except b.
	public static boolean method5(String s) {
		return s.matches("[^b]*");
	}

	// A method that returns true if the string contains a number less than 300
	// (using regular expression).
	public static boolean method6(String s) {
		return s.matches("[^0-9]*[12]?[0-9]{1,2}[^0-9]*");
	}

	// A method that returns true if the string contains a valid IP number.
	...
	// Create a program that reads a text file and removes all blank lines
	public static String method8(String s) {
		return s.replaceAll(" ", "");
	}
}
