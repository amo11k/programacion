...
class DrawPanel2 extends JPanel {
	private void doDrawing(Graphics g) {
		...
		GradientPaint gp1 = new GradientPaint(5, 5, Color.red, 80, 20,
				Color.black, true);
		g2d.setPaint(gp1);
		g2d.fillRect(20, 20, 300, 40);
		GradientPaint gp2 = new GradientPaint(5, 25, Color.yellow, 20, 2,
				Color.black, false);
		g2d.setPaint(gp2);
		g2d.fillRect(20, 80, 300, 40);
		GradientPaint gp3 = new GradientPaint(5, 25, Color.green, 2, 2,
				Color.black, false);
		g2d.setPaint(gp3);
		...
		GradientPaint gp5 = new GradientPaint(0, 0, Color.orange, 0, 20,
				Color.black, true);
		g2d.setPaint(gp5);
...
public class GradientsExample extends JFrame {
	public GradientsExample() {
		DrawPanel2 dpnl = new DrawPanel2();
		add(dpnl);
		setSize(350, 350);
		setTitle("Gradients");
